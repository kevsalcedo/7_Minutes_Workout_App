...
import kesam.learning.a7minutesworkoutapp.databinding.ItemExerciseStatusBinding
...
class ExerciseStatusAdapter (val items: ArrayList<ExerciseModel>):
        ...
        when{
            model.getIsSelected() ->{
                holder.tvItem.background = ContextCompat.getDrawable(
                    holder.itemView.context, R.drawable.item_circular_color_thin_accent_border)
    ...
    override fun getItemCount(): Int {
        return items.size // ADAPTER.size
    }
